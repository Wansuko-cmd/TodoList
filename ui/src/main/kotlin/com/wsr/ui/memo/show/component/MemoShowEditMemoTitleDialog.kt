...
@Composable
fun MemoShowEditMemoTitleDialog(
    ...
    Dialog(onDismissRequest = onDismiss) {
        Surface {
            Column(
                ...
                Text(
                    text = stringResource(id = R.string.memo_show_edit_title_memo_title_title),
                ...
                Row(
                    ...
                    Button(
                        ...
                        Text(
                            color = Color.White,
                            text = stringResource(id = R.string.memo_show_edit_title_dismiss_button),
                        )
                    }
                    ...
                    Button(
                        ...
                        Text(
                            color = Color.White,
                            text = stringResource(id = R.string.memo_show_edit_title_confirm_button),
                        )
                    }
                }
